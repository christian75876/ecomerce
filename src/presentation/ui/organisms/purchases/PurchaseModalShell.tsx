...
const PurchaseModalShell = ({
  ...
  return (
    ...
    >
      <Box
        className={`relative mx-auto my-auto max-h-[90vh] w-full overflow-y-auto ${maxWidthClassName} rounded-[1.75rem] bg-white p-6 shadow-[0_24px_60px_rgba(15,23,42,0.22)]`}
